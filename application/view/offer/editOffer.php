										...
										<div class="form-group">
											...
											<div class="col-sm-8">
										    	<select name="offer_type" class="form-control">
													...
													<option value="1" <?= $this->offer->offer_type == 1 ? 'selected' : ''; ?>>Práctica Pre-Profesional</option>
													<option value="2" <?= $this->offer->offer_type == 2 ? 'selected' : ''; ?>>Proyecto de Vinculación</option>
												</select>
										    </div>
										</div>
										<div class="form-group">
