...
<html lang="en-US">
	<head>
		...
		<title>Mis Ofertas | Internship Finder</title>
					...
					<div class="row">
						<div class="noo-main col-md-8">
							<div class="jobs posts-loop">
								...
								<div><a class="btn btn-primary mb-2" href="<?= Config::get('URL'); ?>offer/addoffer">Agregar Oferta</a></div>
							</div>
						</div>
							...
							<div class="noo-sidebar-wrap">
								<div class="widget widget_noo_advanced_search_widget">
									...
									<form class="widget-advanced-search" id="search-form" action="<?= Config::get('URL'); ?>offer/search" method="post">
										...
										<div class="form-group">
											<label class="h5">Tipo Oferta</label>
											<select class="form-control" name="offer_type" id="offer_type">
												<option class="text-placeholder" value="">- Selecciona una Opción -</option>
												<option value="1" <?= Request::get('offer_type') == 1 ? 'selected' : ''; ?>>Práctica Pre Profesional</option>
												<option value="2" <?= Request::get('offer_type') == 2 ? 'selected' : ''; ?>>Proyecto de Vinculación</option>
											</select>
										</div>
										<div class="form-group">
