jQuery(document).ready(function($) {
	function search() {
		...
		$.ajax({
			type: "POST",
			url: "http://jaec86.com/offer/searchOffer",
			dataType: 'json',
			cache: false,
			data: formData,
